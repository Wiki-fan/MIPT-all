...
postheadspace={5px},headformat={\makebox[0pt][r]{\NAME\ \NUMBER\ }\setbox0\hbox{\ }\hspace{-\the\wd0}\NOTE}]{stmtstyle}
\declaretheorem[style=problemstyle,numbered=no,name=Утв]{stmt}

\declaretheoremstyle[notefont=\bfseries,notebraces={}{},headpunct={},%
postheadspace={5px},headformat={\makebox[0pt][r]{\NAME\ \NUMBER\ }\setbox0\hbox{\ }\hspace{-\the\wd0}\NOTE}]{thmstyle}
\declaretheorem[style=problemstyle,numbered=no,name=Теор]{thm}
